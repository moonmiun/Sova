...
get_slot(tRNA, "anticodon")

# Update slot information

get_slot(tRNA, "assembly")
tRNA <- set_slot(tRNA, "assembly", "hg19")
get_slot(tRNA, "assembly")

# Transform FASTA file in sequence

path <- system.file("tests", "sequence.fasta", package = "Sova")
sequence <- readFasta(path)

# Validate coordinates
sequence <- validateGeneInputs(123, 344, '+', sequence)
